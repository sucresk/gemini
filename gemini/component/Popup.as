package gemini.component 
{
	...
	public class Popup
	{
		 ...
		 * @param	skin  美术资源的链接名
		 */
		public function Popup(skin:String) 
		{
			this.skin = AssetManager.instance.getMovieClip(skin);
		}
		
		public static function create(popClass:Class):Popup {
		...
		public function show(parent:DisplayObjectContainer):void {
			skin.x = (App.STAGE_W - skin.width) / 2;
			skin.y = (App.STAGE_H - skin.height) / 2;
			parent.addChild(skin);
			TweenLite.from(skin, 0.3, { y:(skin.y + 100),
										alpha:0
									  } 
						   );
		}
